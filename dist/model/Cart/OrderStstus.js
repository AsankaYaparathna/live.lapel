...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, field: "name" }),
    __metadata("design:type", String)
], OrderStatus.prototype, "name", void 0);
exports.OrderStatus = OrderStatus = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "LAPEL_ORDER_STATUS", timestamps: true, updatedAt: 'updatedAt', createdAt: 'createdAt' })
], OrderStatus);
