...
exports.UserTrouserMeasurementRepo = void 0;
...
class UserTrouserMeasurementRepo {
    //body
    bodyMeasurementCreate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield TrouserBodyMeasurement_1.TrouserBodyMeasurement.create(model);
            }
            catch (err) {
    ...
    bodyMeasurementUpdate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserBodyMeasurement_1.TrouserBodyMeasurement.findOne({ where: { id: model.id } });
                if (result) {
    ...
    bodyMeasurementDelete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserBodyMeasurement_1.TrouserBodyMeasurement.findOne({ where: { id: id } });
                if (result) {
    ...
    standardSizecreate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield TrouserStandardSize_1.TrouserStandardSize.create(model);
            }
            catch (err) {
    ...
    standardSizeUpdate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserStandardSize_1.TrouserStandardSize.findByPk(model.id);
                if (result) {
                    yield result.update(model);
                    return true;
                }
    ...
    standardSizeGetById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserStandardSize_1.TrouserStandardSize.findByPk(id);
                return result;
            }
            catch (error) {
    ...
    //copyFav
    copyFavurementCreate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield TrouserCopyFavorite_1.TrouserCopyFavorite.create(model);
            }
            catch (err) {
                throw new Error("Failed to create User!| " + err.message);
            }
    ...
    copyFavUpdate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserCopyFavorite_1.TrouserCopyFavorite.findByPk(model.id);
                if (result) {
                    yield result.update(model);
                    return true;
                }
    ...
    copyFavGetById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield TrouserCopyFavorite_1.TrouserCopyFavorite.findByPk(id);
                return result;
            }
            catch (error) {
                throw new Error("Failed to get shirt standard size by ID: " + error);
...
exports.UserTrouserMeasurementRepo = UserTrouserMeasurementRepo;
