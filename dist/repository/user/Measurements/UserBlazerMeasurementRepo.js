...
exports.UserBlazerMeasurementRepo = void 0;
...
class UserBlazerMeasurementRepo {
    //body
    bodyMeasurementCreate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield BlazerBodyMeasurement_1.BlazerBodyMeasurement.create(model);
            }
            catch (err) {
    ...
    bodyMeasurementUpdate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield BlazerBodyMeasurement_1.BlazerBodyMeasurement.findOne({ where: { id: model.id } });
                if (result) {
    ...
    bodyMeasurementDelete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield BlazerBodyMeasurement_1.BlazerBodyMeasurement.findOne({ where: { id: id } });
                if (result) {
    ...
    standardSizecreate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield BlazerStandardSize_1.BlazerStandardSize.create(model);
            }
            catch (err) {
    ...
    standardSizeUpdate(model) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield BlazerStandardSize_1.BlazerStandardSize.findByPk(model.id);
                if (result) {
                    yield result.update(model);
                    return true;
                }
    ...
    standardSizeGetById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield BlazerStandardSize_1.BlazerStandardSize.findByPk(id);
                return result;
            }
            catch (error) {
...
exports.UserBlazerMeasurementRepo = UserBlazerMeasurementRepo;
